  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-white">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-black text-white p-12 relative overflow-hidden">
        ...
        >
          <div>
            <span className="text-2xl font-black font-mono">500+</span>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold mt-0.5">Students</p>
          </div>
          <div className="w-px h-8 bg-zinc-800" />
          <div>
            <span className="text-2xl font-black font-mono">2K+</span>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold mt-0.5">Simulations</p>
          </div>
          <div className="w-px h-8 bg-zinc-800" />
          <div>
            <span className="text-2xl font-black font-mono">30+</span>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold mt-0.5">Universities</p>
          </div>
        </motion.div>
      </div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold">Secure Auth</span>
              <div className="flex-1 h-px bg-zinc-200" />
            </div>
          </div>
